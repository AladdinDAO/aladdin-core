...
import VaultCompoundUSDT from '../../build/contracts/VaultCompoundUSDT.json'
import TokenMaster from '../../build/contracts/TokenMaster.json'
import StrategyCompoundUSDT from '../../build/contracts/StrategyCompoundUSDT.json'
...
export async function getFixture(provider: Web3Provider, [wallet]: Wallet[]): Promise<Fixture> {
    ...
    const strategyUSDTCompound = await deployContract(wallet, StrategyCompoundUSDT, [controller.address],overrides )
